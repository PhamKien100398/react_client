                ...
                <div class="px-5 py-4 m-6">
                    <div class="py-3">
                        <div class="flex justify-between items-center mb-3 px-2">
                            ...
                            <h2 class="select-none list-title title-coming flex items-center"><FontAwesomeIcon icon = {faMinus} style={{color: "rgb(27, 209, 233)", margin:"10px"}}/>Bài thi sắp tới</h2>
                            </div>
                        </div>
                        <div class="list-current-exam flex flex-wrap w-full">
                                {
                                    this.state.exams.map((exam) =>{
                                        return (!exam.isStarted && <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
                    ...
                    <div class="py-3">
                        <div class="flex justify-between items-center mb-3 px-2">
                            <div class="current-exam lg:text-2xl font-semibold text-gray-800">
                            <h2 class="select-none list-title title-coming flex items-center"><FontAwesomeIcon icon = {faMinus} style={{color: "rgb(27, 209, 233)", margin:"10px"}}/>Bài thi đã thực hiện</h2>
                            </div>
                        ...
                        <div class="list-current-exam flex flex-wrap w-full">
                                {
                                    this.state.exams.map((exam) =>{
                                        return (exam.isFinished && <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
                                                    <ExamCardComponent examCard = {exam}/>
                                                </div>)
                                                {/* <div class="my-1 px-1 w-full md:w-1/2 lg:my-4 lg:px-4 lg:w-1/3">
                                                    <Skeleton/>
